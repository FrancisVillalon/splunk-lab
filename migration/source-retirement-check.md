...
| #   | Action                                                                                                                                                                                                                            | Done | Date       |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ---------- |
| 1   | Run `sha512sum -c splunk-migration.sha512` against the host copy of the backup artifacts                                                                                                                                          | TRUE | 08/09/2026 |
| 2   | Confirm the container has been up and healthy across the soak window                                                                                                                                                              | TRUE | 08/09/2026 |
| 3   | Power off the VM, leave it in inventory                                                                                                                                                                                           | TRUE | 08/09/2026 |
| 4   | Run every check in [Verification](#verification)                                                                                                                                                                                  | TRUE | 08/09/2026 |
| 5   | Delete the VM and its virtual disks                                                                                                                                                                                               | TRUE | 08/09/2026 |
| 6   | Remove the VMware shared folder definition backing `/mnt/hgfs`                                                                                                                                                                    | TRUE | 08/09/2026 |
| 7   | Clear any host-side references to `172.16.58.10` in `/etc/hosts`, `known_hosts` and any static routes                                                                                                                             | TRUE | 08/09/2026 |
| 8   | Mark [baseline-ubuntu-vm](../environment/baseline-ubuntu-vm.md) as retired with the date, and set stage 6 in [migration-overview](migration-overview.md) to complete | TRUE | 08/09/2026 |

# Rollback window

| Field                | Value                                                                                                                                                                         |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Span                 | Migration date → 8 September 2026                                                                                                                                             |
...
| Check                                                                    | Result | Notes |
| ------------------------------------------------------------------------ | ------ | ----- |
| VM is powered off                                                        | PASS   |       |
| Target container still healthy with the source gone                      | PASS   |       |
| Scenario checks still pass against the target                            | PASS   |       |
| Backup artifacts still present on the host and still pass `sha512sum -c` | PASS   |       |
| Clear any host side references to the retired system                     | PASS   |       |
| Documentation updated to reflect migration                               | PASS   |       |
